...
Route::group(['middleware' => 'auth'], function(){
    ...
    Route::group(['middleware' => 'admin'], function(){
        ...
        Route::delete('/admin/posts/{id}/deactivate',[PostsController::class,'deactivate'])->name('admin.posts.deactivate');

        Route::patch('/admin/posts/{id}/activate',[PostsController::class,'activate'])->name('admin.posts.activate');
